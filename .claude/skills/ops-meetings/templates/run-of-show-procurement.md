...
## [0:40 - 0:55] DEEP-DIVE QUEUE

Items that need >8 minutes of technical discussion are NOT discussed here.

| Topic | Required Attendees | Proposed Time | Duration |
|-------|-------------------|---------------|----------|
| [topic] | [names] | [day/time] | 30 min |
| [topic] | [names] | [day/time] | 30 min |

*Schedule these as separate focused sessions. 2-3 people max.*

---

## [0:55 - 1:00] CLOSE (Yoni or Jeroen)

- Read back all decisions made
- Read back all action items with owners + deadlines
- Preview next week's expected decision items
- **Check: did every segment produce an output?** If the answer is yes, the time was well spent regardless of duration.

---

## Rules

- **No thermodynamics debates.** Technical deep-dives go to separate sessions.
...
- **Every segment must produce an output.** If a 2-hour session resolves 8 vendor decisions, that's a great meeting. If a 30-minute session resolves zero, that's a bad one. Judge by substance, not clock.
