...
|---|---|---|---|
| Traditioneel datacenter | 6--15 kW/rack (2024 gemiddelde: ~8 kW/rack) | Luchtkoeling (air cooling) | Industrie standaard; Uptime Institute 2024 |
...
| AI next-gen (Vera Rubin) | 190--230 kW/rack; tot 600 kW/rack (Rubin Ultra) | Volledige vloeistofkoeling; immersiekoeling | Tom's Hardware 2025; NVIDIA roadmap |
...
**DLC-adoptiegraad / DLC adoption rate:** ~19% van alle datacenters; 47% van AI DC vloeistofkoeling is DLC (Uptime Institute / Introl 2025).

[Introl 2025; Schneider Electric White Papers; NVIDIA Design Guides; Uptime Institute 2024]
...
NB: Werkelijke omzet varieert sterk afhankelijk van GPU-dichtheid, benuttingsgraad, prijsmodel, type werklast, en contractmix. Bovenstaande cijfers zijn indicatief, gebaseerd op blended aannames, en betreffen een **H100-era momentopname (2024-2025)**. Niet lineair projecteren naar 2030 vanwege GPU-prijsdeflatie en generatiewisselingen.
...
|---|---|---|---|---|---|
| Hyperscaler CAPEX (totaal) | ~$443B (voorwaartse schatting; werkelijk Big 4 ~$381-383B; top 5 ~$400-420B) | ~$602B | -- | -- | CreditSights/IEEE ComSoc |
| Waarvan AI-gerelateerd (of which AI) | ~75% (~$332B) | ~75% (~$452B) | -- | -- | CreditSights/IEEE ComSoc |
| Mondiale AI CAPEX | $423B | $571B (andere schattingen: $660-690B hyperscaler-only [Futurum]; ~$750B top 5 [CreditSights]) | $1.3T | ~25% | UBS |
